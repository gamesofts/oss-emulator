...
module OssEmulator
  ...
  module ErrorCode
    ...
    NO_SUCH_UPLOAD         = { error_code: 'NoSuchUpload', status_code: 404, message: 'The specified upload does not exist.' }
